...
export class SeataGuestComponent implements OnInit {
  ...
  public floorSelected: string = "";
   ...
   /*added for reassign server */
    ...
    ngOnInit() {       
      ...
      { this.user_accept.UserName = this.user_accept.FirstName+" "+this.user_accept.LastName; }
    }
  ...
  selectseats(selectseats: any) {
    ...
    getwaitlist() {
      ...
      this.seataguestService.getwaitlist(this.restID, this.openDate, this.SessionID).subscribe((res: any) => {
